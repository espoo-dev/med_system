...
part of 'add_procedure.store.dart';
...
mixin _$AddProcedureStore on _AddProcedureStoreBase, Store {
  Computed<bool>? _$isValidDataComputed;

  @override
  bool get isValidData =>
      (_$isValidDataComputed ??= Computed<bool>(() => super.isValidData,
              name: '_AddProcedureStoreBase.isValidData'))
          .value;

  late final _$saveStateAtom =
      Atom(name: '_AddProcedureStoreBase.saveState', context: context);
  ...
  late final _$_errorMessageAtom =
      Atom(name: '_AddProcedureStoreBase._errorMessage', context: context);
  ...
  late final _$_nameAtom =
      Atom(name: '_AddProcedureStoreBase._name', context: context);
  ...
  late final _$_codeAtom =
      Atom(name: '_AddProcedureStoreBase._code', context: context);
  ...
  late final _$_descriptionAtom =
      Atom(name: '_AddProcedureStoreBase._description', context: context);
  ...
  late final _$_amountCentsAtom =
      Atom(name: '_AddProcedureStoreBase._amountCents', context: context);
  ...
  late final _$createProcedureAsyncAction =
      AsyncAction('_AddProcedureStoreBase.createProcedure', context: context);

  @override
  Future createProcedure() {
    return _$createProcedureAsyncAction.run(() => super.createProcedure());
  }

  late final _$_AddProcedureStoreBaseActionController =
      ActionController(name: '_AddProcedureStoreBase', context: context);

  @override
  void setName(String name) {
    final _$actionInfo = _$_AddProcedureStoreBaseActionController.startAction(
        name: '_AddProcedureStoreBase.setName');
    try {
      return super.setName(name);
    } finally {
      _$_AddProcedureStoreBaseActionController.endAction(_$actionInfo);
    }
  }
  ...
  void setCode(String code) {
    final _$actionInfo = _$_AddProcedureStoreBaseActionController.startAction(
        name: '_AddProcedureStoreBase.setCode');
    try {
  ...
  void setDescription(String description) {
    final _$actionInfo = _$_AddProcedureStoreBaseActionController.startAction(
        name: '_AddProcedureStoreBase.setDescription');
    try {
  ...
  void setAmountCents(String amountCents) {
    final _$actionInfo = _$_AddProcedureStoreBaseActionController.startAction(
        name: '_AddProcedureStoreBase.setAmountCents');
    try {
